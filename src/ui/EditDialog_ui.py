...
class Ui_EditDialog(object):
    def setupUi(self, EditDialog):
        ...
        EditDialog.resize(860, 607)
        self.verticalLayout = QVBoxLayout(EditDialog)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.horizontalLayout_3 = QHBoxLayout()
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")
        self.SKvalueButton = QPushButton(EditDialog)
        self.SKvalueButton.setObjectName(u"SKvalueButton")

        self.horizontalLayout_3.addWidget(self.SKvalueButton)

        self.applyButton = QPushButton(EditDialog)
        self.applyButton.setObjectName(u"applyButton")

        self.horizontalLayout_3.addWidget(self.applyButton)

        self.saveButton = QPushButton(EditDialog)
        self.saveButton.setObjectName(u"saveButton")

        self.horizontalLayout_3.addWidget(self.saveButton)

        self.cancelButton = QPushButton(EditDialog)
        ...
        self.headingEdit.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self.cogEdit.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self.logEdit.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self.twsEdit.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self.formLayout_2.setWidget(3, QFormLayout.FieldRole, self.seastateBox)
        ...
        self.formLayout_2.setWidget(4, QFormLayout.FieldRole, self.cloudcoverSpinBox)
        ...
        self.formLayout_2.setWidget(5, QFormLayout.FieldRole, self.visibilityBox)
        ...
        self.formLayout_2.setWidget(6, QFormLayout.FieldRole, self.crewBox)
        ...
        self.formLayout_2.setWidget(7, QFormLayout.FieldRole, self.crewEdit)

        self.delCrewButton = QPushButton(EditDialog)
        self.delCrewButton.setObjectName(u"delCrewButton")

        self.formLayout_2.setWidget(8, QFormLayout.FieldRole, self.delCrewButton)
    ...
    def retranslateUi(self, EditDialog):
        ...
        self.SKvalueButton.setText(QCoreApplication.translate("EditDialog", u"Get values from SK", None))
        self.applyButton.setText(QCoreApplication.translate("EditDialog", u"Apply", None))
        self.saveButton.setText(QCoreApplication.translate("EditDialog", u"Safe", None))
        self.cancelButton.setText(QCoreApplication.translate("EditDialog", u"Cancel", None))
        self.label.setText(QCoreApplication.translate("EditDialog", u"Date", None))
