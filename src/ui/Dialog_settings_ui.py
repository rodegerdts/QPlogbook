...
class Ui_DialogSettings(object):
    ...
    def retranslateUi(self, DialogSettings):
        ...
        self.label_29.setText(QCoreApplication.translate("DialogSettings", u"Entry interval:", None))
#if QT_CONFIG(tooltip)
        ...
        self.label_31.setText(QCoreApplication.translate("DialogSettings", u"Track interval:", None))
        self.label_32.setText(QCoreApplication.translate("DialogSettings", u"Server timeout:", None))
#if QT_CONFIG(tooltip)
        ...
        self.doubleSpinBox_UTCoffset.setPrefix("")
        self.doubleSpinBox_UTCoffset.setSuffix(QCoreApplication.translate("DialogSettings", u"h", None))
        self.doubleSpinBox_timeout.setSuffix(QCoreApplication.translate("DialogSettings", u"s", None))
#if QT_CONFIG(tooltip)
        self.spinBox_track_interv.setToolTip(QCoreApplication.translate("DialogSettings", u"<html><head/><body><p>How often should the skeduler be trigger to check for status change.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.spinBox_track_interv.setSuffix(QCoreApplication.translate("DialogSettings", u"s", None))
